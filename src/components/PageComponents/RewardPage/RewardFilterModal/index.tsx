...
import RewardsFilterForm from '@/components/PageComponents/RewardPage/RewardFilterModal/filter-form';
...
const RewardsFilterModal = ({ open, onOpenChange }: Props) => {
  ...
  return (
    <Modal open={open} onOpenChange={onOpenChange} >
      <ModalContent hideCloseIcon>
        ...
        <Separator />
        <RewardsFilterForm onClose={() => onOpenChange(false)} control={filterControl} />
      </ModalContent>
    </Modal>
  );
};

export default RewardsFilterModal;