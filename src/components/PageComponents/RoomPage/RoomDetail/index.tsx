...
const RoomDetail = ({ roomDetail }: Props) => {
  return (
      ...
      <div className='flex flex-1 flex-col'>
        <Tabs defaultValue="general-information" className='w-full gap-6 flex flex-col'>
          ...
          <TabsContent value="players">
            <PlayersTab roomId={roomDetail.room_code} players={roomDetail.room_participants} endDateTime={`${roomDetail.end_date} ${roomDetail.start_time}`} />
          </TabsContent>
        </Tabs>
      </div>
    </div>
