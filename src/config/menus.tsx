...
const SidebarMenus: MenuItems[] = [
  ...
  {
    title: 'Game Catalog', href: '/game', icon: (active) => <Layer variant={active ? 'Bold' : 'Outline'} />, permissions: ['games']
  },
  {
    title: 'Tier', href: '/tier', icon: (active) => <Ranking variant={active ? 'Bold' : 'Outline'} />, permissions: ['tier']
  },
  {
    title: 'Rewards', href: '/rewards', icon: (active) => <Ticket variant={active ? 'Bold' : 'Outline'} />, permissions: ['rewards']
  },
  {
    title: 'Badges', href: '/badges', icon: (active) => <MedalStar variant={active ? 'Bold' : 'Outline'} />, permissions: ['badge']
  },
  {
    title: 'Cafe Management', href: '/cafe', icon: (active) => <Shop variant={active ? 'Bold' : 'Outline'} />, permissions: ['cafeManagement']
  },
  {
    title: 'Banner', href: '/banner', icon: (active) => <Like variant={active ? 'Bold' : 'Outline'} />, permissions: ['banner']
  },
  {
    title: 'User Control', href: '#', icon: (active) => <Profile2User variant={active ? 'Bold' : 'Outline'} />, permissions: ['member', 'admin'],
    child: [
      {
