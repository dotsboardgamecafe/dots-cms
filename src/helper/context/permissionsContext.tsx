    ...
    const getPermissionsObject = async () => {
      ...
      const permissionObject: IPermissionsContextValue = {
        ...
        tournament: {
          ...
          removeParticipants: permissionList.includes('tournament-participants-delete'),
          addParticipants: permissionList.includes('tournament-participants-add')
        },
        member: {
          ...
          adjustVP: permissionList.includes('member-adjust-vp'),
          showVpHistory: permissionList.includes('member-history-vp')
        }
      }
