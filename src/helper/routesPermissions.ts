...
export function getLandingPage(permissions: string[]) {
  ...
  if (permissions.includes('tier')) return '/tier'
  if (permissions.includes('reward')) return '/rewards'
  if (permissions.includes('badge')) return '/badges'
  if (permissions.includes('cafe')) return '/cafe'
  if (permissions.includes('banner')) return '/banner'
  if (permissions.includes('member')) return '/member'
  if (permissions.includes('admin')) return '/admin'
  if (permissions.includes('game-mechanics')) return '/mechanic'
  return '/'
}